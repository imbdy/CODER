...
export const TASK_PRIORS = {
  'create-component': { 'micro-interactions': 5, 'component-composition': 4, 'visual-design': 3, accessibility: 2.5, typography: 1.5, 'anti-slop': 1 },
  'create-page': { 'frontend-master': 5, layout: 4, typography: 3.5, 'visual-design': 3, 'micro-interactions': 2.5, 'responsive-design': 2.5, 'anti-slop': 3, backgrounds: 1.5 },
  'create-app': { 'frontend-master': 5, layout: 4, 'component-composition': 3, 'ui-ux': 3, 'responsive-design': 2.5, accessibility: 2, 'anti-slop': 2.5 },
  enhance: { 'design-review': 4, 'visual-design': 4, 'micro-interactions': 3, 'anti-slop': 3, typography: 2.5, motion: 2 },
  redesign: { 'frontend-master': 4, 'design-review': 4, 'visual-design': 4, layout: 3.5, typography: 3, 'anti-slop': 3.5, 'component-composition': 2 },
  ...
  accessibility: { accessibility: 6, 'ui-ux': 3, 'responsive-design': 2 },
