...
/** Premium 3D + scroll storytelling layer — only when requested, but high leverage. */
export function emitPremium3DScrollCss() {
  return `
/* ---------------------------------------------------------- premium 3D + scroll ---- */
...
@media (max-width: 60rem) {
  .hero-webgl { opacity: 0.6; }
  .scroll-pin__sticky { height: auto; position: relative; }
}
@media (prefers-reduced-motion: reduce) {
...
function isPremiumRequest(request = '', direction) {
